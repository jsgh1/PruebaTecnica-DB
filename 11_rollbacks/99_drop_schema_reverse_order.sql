-- Eliminación manual de objetos en orden inverso de dependencias.
DROP TABLE IF EXISTS baggage_incident_event CASCADE;
DROP TABLE IF EXISTS baggage_incident CASCADE;
DROP TABLE IF EXISTS baggage_incident_type CASCADE;
DROP TABLE IF EXISTS baggage_incident_status CASCADE;
